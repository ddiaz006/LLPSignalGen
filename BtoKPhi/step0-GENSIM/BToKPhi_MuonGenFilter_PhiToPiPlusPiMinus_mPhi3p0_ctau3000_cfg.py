...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            particle_property_file = cms.FileInPath('GeneratorInterface/CustomLLPEvtGenSettings/data/evt_BToScalarLLP_mass3p0_ctau3000.pdl'),
            user_decay_file = cms.vstring('GeneratorInterface/CustomLLPEvtGenSettings/data/BToScalarLLPdecay_mass3p0_SToPiPlusPiMinus.DEC')
        ),
