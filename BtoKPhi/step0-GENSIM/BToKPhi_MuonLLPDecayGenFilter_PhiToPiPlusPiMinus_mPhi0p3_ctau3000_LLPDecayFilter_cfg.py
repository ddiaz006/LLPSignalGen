...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('B -> K S, with long-lived S, m=1.0GeV, ctau=3000.0mm'),
    name = cms.untracked.string('B -> K S, with long-lived S, m=1.0GeV, ctau=3000.0mm'),
