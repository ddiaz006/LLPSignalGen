...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('B -> K S, with long-lived S, m=1.0GeV, ctau=1000.0mm'),
    name = cms.untracked.string('B -> K S, with long-lived S, m=1.0GeV, ctau=1000.0mm'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            particle_property_file = cms.FileInPath('GeneratorInterface/CustomLLPEvtGenSettings/data/evt_BToScalarLLP_mass1p0_ctau10000.pdl'),
            user_decay_file = cms.vstring('GeneratorInterface/CustomLLPEvtGenSettings/data/BToScalarLLPdecay_mass1p0_SToPiPlusPiMinus.DEC')
        ),
