...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            particle_property_file = cms.FileInPath('GeneratorInterface/CustomLLPEvtGenSettings/data/evt_BToScalarLLP_mass0p5_ctau5000.pdl'),
            user_decay_file = cms.vstring('GeneratorInterface/CustomLLPEvtGenSettings/data/BToScalarLLPdecay_mass0p5_SToPiPlusPiMinus.DEC')
        ),
